...
public class EqualsTest {
    ...
    public static void main(String[] args) {
        var alice1 = new Employee("Alice Adams", 75000.0, 1987, 12, 15);
        var alice2 = alice1;
        var alice3 = new Employee("Alice Adams", 75000.0, 1987, 12, 15);
        var bob = new Employee("Bob Brandson", 50000.0, 1989, 10, 1);
        ...
        var carl = new Manager("Carl Cracker", 80000.0, 1987, 12, 15);
        var boss = new Manager("Carl Cracker", 80000.0, 1987, 12, 15);
        boss.setBonus(5000);
