...
public class ParamTest {
    ...
    public static void main(String[] args) {
        ...
        var harry = new simpleEmployee("Harry", 5000.0);
        ...
        System.out.println("\nTesting swap:");
        var a = new simpleEmployee("Alice", 70000.0);
        var b = new simpleEmployee("Bob", 60000.0);
    ...
    public static void tripleSalary(simpleEmployee e) {
        e.raiseSalary(200);
